...
class Restoration_Sequence(object):
    ...
    def sequence(self):
        ...
        # Write switch status as we obtain from restoration problem
        Status=[573, 913, 1227, 1240, 1316, 1318, 1319, 1323, 1324, 1325, 1326]
        ...
        # Freezing the remaining switches from the restoration problem to be 1
        for k in range (0, nEdges):
            if k not in Status:
                prob += xij[k]==1
